                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-solid @error('rate') is-invalid @enderror" name="rate" id="rate" placeholder="Please Enter Rate" value="{{ $taxrate->rate }}">
                            @error('rate')
                            <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
