...
<div class="content">
    ...
    <!-- <h3 class="mb-3" style="margin-bottom: 30px">Technical Support <a href="/client/registraion" class="btn btn-info mt-o" style="float: right;">New Client</a></h3> -->
    ...
    <div class="container-fluid" style="overflow-x:auto;">
        <table id="technicalsupportTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.technical_confirm', function(event) {
