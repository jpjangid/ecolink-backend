...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('admin/pages/store') }}" id="addData" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid @error('title') is-invalid @enderror" name="title" id="title" placeholder="Please Enter Page title" value="{{ old('title') }}">
                            @error('title')
