...
class CartController extends Controller
{
  ...
  public function deleteCartItems(Request $request)
  {
    ...
    if (!empty($cart)) {
      ...
      $remainCartItems = Cart::select('id', 'user_id', 'product_id', 'quantity')->where('user_id', $user->id)->with(['product:id,name,sale_price,image,alt,minimum_qty,slug,parent_id', 'product.category:id,slug'])->get();
